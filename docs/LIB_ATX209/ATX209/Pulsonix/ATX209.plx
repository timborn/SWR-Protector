...
(library Library_1
	...
	(patternDef "ATX209" (originalName "ATX209")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 5.425, 2.540) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.15 6.24) (pt 13.85 6.24) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.85 6.24) (pt 13.85 -1.16) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 13.85 -1.16) (pt -1.15 -1.16) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -1.15 -1.16) (pt -1.15 6.24) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "ATX209" (originalName "ATX209") (compHeader (numPins 8) (numParts 1) (refDesPrefix K)
		...
		(attr "<Hyperlink>" "https://pdf1.alldatasheet.com/datasheet-pdf/view/117941/NAIS/TX2-5V.html")
		(attr "<Component Height>" "8.2")
		(attr "<STEP Filename>" "ATX209.stp")
